...
check_sys
echo -e " Iptables 端口转发一键管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
"——————————————————————————————————"
 ${Green_font_prefix}1.${Font_color_suffix} 升级脚本
 ${Green_font_prefix}2.${Font_color_suffix} 安装 iptables
 ${Green_font_prefix}3.${Font_color_suffix} 清空 iptables 端口转发
 ${Green_font_prefix}4.${Font_color_suffix} 查看 iptables 端口转发
 ${Green_font_prefix}5.${Font_color_suffix} 添加 iptables 端口转发
 ${Green_font_prefix}6.${Font_color_suffix} 删除 iptables 端口转发
 ${Green_font_prefix}0.${Font_color_suffix} 退出脚本
——————————————————————————————————
注意：初次使用前请请务必执行 ${Green_font_prefix}2. 安装 iptables${Font_color_suffix}(不仅仅是安装)" && echo
